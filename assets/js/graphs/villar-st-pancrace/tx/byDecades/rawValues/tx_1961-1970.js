 import * as d3 from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
        ...
        d3.json("../../api/villar-st-pancrace/tx/TX_VILLAR-ST-PANCRACE.json").then(rawData => {
            ...
            const from1961To1970 = data.filter(d => d.date.getFullYear() >= 1961 && d.date.getFullYear() < 1970);

            from1961To1970.sort((a, b) => a.date - b.date);

            const step = 1;
            const filtered = from1961To1970.filter((_, i) => i % step === 0);
