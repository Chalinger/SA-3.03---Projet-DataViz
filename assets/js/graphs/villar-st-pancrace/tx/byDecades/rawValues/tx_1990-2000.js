 import * as d3 from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
        ...
        d3.json("../../api/villar-st-pancrace/tx/TX_VILLAR-ST-PANCRACE.json").then(rawData => {
            ...
            const from1990To2000 = data.filter(d => d.date.getFullYear() >= 1990 && d.date.getFullYear() < 2000);

            from1990To2000.sort((a, b) => a.date - b.date);

            const step = 1;
            const filtered = from1990To2000.filter((_, i) => i % step === 0);
