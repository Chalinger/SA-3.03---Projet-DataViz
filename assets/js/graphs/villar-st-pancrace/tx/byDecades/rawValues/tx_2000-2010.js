 import * as d3 from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
        ...
        d3.json("../../api/villar-st-pancrace/tx/TX_VILLAR-ST-PANCRACE.json").then(rawData => {
            ...
            const from2000To2010 = data.filter(d => d.date.getFullYear() >= 2000 && d.date.getFullYear() < 2010);

            from2000To2010.sort((a, b) => a.date - b.date);

            const step = 1;
            const filtered = from2000To2010.filter((_, i) => i % step === 0);
