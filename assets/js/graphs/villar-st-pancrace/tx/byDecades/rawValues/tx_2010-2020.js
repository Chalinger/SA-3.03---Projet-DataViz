 import * as d3 from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
        ...
        d3.json("../../api/villar-st-pancrace/tx/TX_VILLAR-ST-PANCRACE.json").then(rawData => {
            ...
            const from2010To2020 = data.filter(d => d.date.getFullYear() >= 2010 && d.date.getFullYear() < 2020);

            from2010To2020.sort((a, b) => a.date - b.date);

            const step = 1;
            const filtered = from2010To2020.filter((_, i) => i % step === 0);
